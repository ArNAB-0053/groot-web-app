        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col gap-4 items-center justify-center text-center">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl mb-4">About Groot</h1>
            ...
            <div className="grid gap-4 grid-cols-2 lg:grid-cols-4 mt-4">
              <div className="flex flex-col gap-2">
                <img
                  alt="Image"
                  className="mx-auto aspect-poster overflow-hidden rounded-xl object-cover object-center w-32 lg:w-48"
                  height="120"
                  src="healthy.jpg"
                  width="200"
                />
